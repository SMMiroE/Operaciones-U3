...
st.title('🌡️ Simulación de Torres de Enfriamiento OU3 FICA-UNSL ❄️(beta)')
...
st.markdown("Miró Erdmann, S. M. (2025). Simulador de Torres de Enfriamiento(v. beta) [Software]. Villa Mercedes, San Luis: FICA-UNSL._")
